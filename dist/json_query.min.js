...
O.map=O.collect=function(t){var r,i=[];return this.exec(function(e){(r=t(e))&&i.push(r)}),i},O.sum=function(t){var r,e=0,n=this.jQ.getterFns[t];return this.criteria.group_by&&(r=!0,e={}),this.exec(function(t,s){r?(e[s]=0,i(t,function(t){e[s]=e[s]+(n(t)||0)})):e+=n(t)||0}),e},O.toJQ=function(){var t=r(this.all,{schema:!0});return t.schema=this.jQ.schema,t.getterFns=this.jQ.getterFns,t},O.destroy=function(){var t=this.all;return i(t,function(t){t._destroy_=!0}),this.records=this.jQ.records=this.records.filter(function(t){return!t._destroy_}),t},//In IE 8 indexOf method not define.
